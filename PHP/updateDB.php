<?php
	...
	if($thisMD5==$prevMD5){
		...
		setupTable('recipes', "create table if not exists `recipes` (   `RecipeID` INT(11) not null auto_increment , primary key (`RecipeID`), `Name` VARCHAR(50) not null , unique `Name_unique` (`Name`), `DateCreated` DATE , `Instructions` TEXT , `Description` TEXT , `SourceID` INT(11) , `PrepTime` VARCHAR(8) default '00:00:00' , `Servings` TINYINT(2) default '0' ) CHARSET latin1", $silent);
