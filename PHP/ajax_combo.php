...
*/
	...
	$lookups = array(   
		'mealdates' => array(   
			'MealID' => array(
				'parent_table' => 'meals',
				'parent_pk_field' => 'MealID',
				'parent_caption' => '`meals`.`Name`',
				'parent_from' => '`meals` ',
				'filterers' => array(),
				'custom_query' => '',
		...
		'recipes' => array(   
			'SourceID' => array(
				'parent_table' => 'sources',
				'parent_pk_field' => 'SourceID',
				'parent_caption' => '`sources`.`FullName`',
				'parent_from' => '`sources` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
		...
		'mealrecipes' => array(   
			...
			'RecipeID' => array(
				...
				'parent_pk_field' => 'RecipeID',
				'parent_caption' => '`recipes`.`Name`',
				'parent_from' => '`recipes` LEFT JOIN `sources` as sources1 ON `sources1`.`SourceID`=`recipes`.`SourceID` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
		...
		'recipeingredients' => array(   
			...
			'IngredientID' => array(
				'parent_table' => 'ingredients',
				'parent_pk_field' => 'IngredientID',
				'parent_caption' => '`ingredients`.`Name`',
				'parent_from' => '`ingredients` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
		...
		'ingredientstores' => array(   
			'IngredientID' => array(
				'parent_table' => 'ingredients',
				'parent_pk_field' => 'IngredientID',
				'parent_caption' => 'IF(CHAR_LENGTH(`ingredients`.`Name`) || CHAR_LENGTH(`ingredients`.`PricingUnit`), CONCAT_WS(\'\', `ingredients`.`Name`, \' - \', `ingredients`.`PricingUnit`), \'\')',
				'parent_from' => '`ingredients` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
			...
			'StoreID' => array(
				'parent_table' => 'stores',
				'parent_pk_field' => 'StoreID',
				'parent_caption' => '`stores`.`Name`',
				'parent_from' => '`stores` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
