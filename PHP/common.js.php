...
function recipes_validateData(){
	$j('.has-error').removeClass('has-error');
	if($j('#Name').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Name", close: function(){ $j('[name=Name]').focus(); $j('[name=Name]').parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
function ingredients_validateData(){
	$j('.has-error').removeClass('has-error');
	if($j('#Name').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Name", close: function(){ $j('[name=Name]').focus(); $j('[name=Name]').parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
function mealrecipes_validateData(){
	$j('.has-error').removeClass('has-error');
	if($j('#MealID').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Meal", close: function(){ $j('[name=MealID]').focus(); $j('[name=MealID]').parents('.form-group').addClass('has-error'); } }); return false; };
	if($j('#RecipeID').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Recipe", close: function(){ $j('[name=RecipeID]').focus(); $j('[name=RecipeID]').parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
function recipeingredients_validateData(){
	$j('.has-error').removeClass('has-error');
	if($j('#RecipeID').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Recipe", close: function(){ $j('[name=RecipeID]').focus(); $j('[name=RecipeID]').parents('.form-group').addClass('has-error'); } }); return false; };
	if($j('#IngredientID').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Ingredient", close: function(){ $j('[name=IngredientID]').focus(); $j('[name=IngredientID]').parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
function ingredientstores_validateData(){
	$j('.has-error').removeClass('has-error');
	if($j('#IngredientID').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Ingredient", close: function(){ $j('[name=IngredientID]').focus(); $j('[name=IngredientID]').parents('.form-group').addClass('has-error'); } }); return false; };
	if($j('#StoreID').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Store", close: function(){ $j('[name=StoreID]').focus(); $j('[name=StoreID]').parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
function sources_validateData(){
	$j('.has-error').removeClass('has-error');
	if($j('#FullName').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Name", close: function(){ $j('[name=FullName]').focus(); $j('[name=FullName]').parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
function stores_validateData(){
	$j('.has-error').removeClass('has-error');
	if($j('#Name').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Name", close: function(){ $j('[name=Name]').focus(); $j('[name=Name]').parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
