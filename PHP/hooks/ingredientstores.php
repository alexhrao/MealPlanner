<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'ingredientstores' table. 
	...
	*/
	 ...
	 *     $data['IngredientID'], $data['StoreID'], $data['Cost']
	...
	*/
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['IngredientStoreID'], $data['IngredientID'], $data['StoreID'], $data['Cost']
