<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'stores' table. 
	...
	*/
	 ...
	 *     $data['Name'], $data['PhoneNumber'], $data['Location'], $data['Notes']
	...
	*/
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['StoreID'], $data['Name'], $data['PhoneNumber'], $data['Location'], $data['Notes']
