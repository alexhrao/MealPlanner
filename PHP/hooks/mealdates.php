<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'mealdates' table. 
	...
	*/
	 ...
	 *     $data['MealID'], $data['MealDate'], $data['MealTime']
	...
	*/
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['MealDateID'], $data['MealID'], $data['MealDate'], $data['MealTime']
