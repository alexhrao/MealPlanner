<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'sources' table. 
	...
	*/
	...
	function sources_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function sources_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function sources_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['FullName'], $data['PhoneNumber'], $data['Description']
	...
	*/
	...
	function sources_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function sources_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function sources_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['SourceID'], $data['FullName'], $data['PhoneNumber'], $data['Description']
	...
	*/
	...
	function sources_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function sources_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function sources_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function sources_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function sources_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function sources_batch_actions(&$args){
