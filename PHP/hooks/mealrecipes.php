<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'mealrecipes' table. 
	...
	*/
	...
	function mealrecipes_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function mealrecipes_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function mealrecipes_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function mealrecipes_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function mealrecipes_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function mealrecipes_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['MealRecipeID'], $data['MealID'], $data['RecipeID']
	...
	*/
	...
	function mealrecipes_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function mealrecipes_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function mealrecipes_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function mealrecipes_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function mealrecipes_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function mealrecipes_batch_actions(&$args){
