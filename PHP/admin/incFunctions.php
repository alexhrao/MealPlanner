	...
	*/
	...
	if(!function_exists('getTableList')){
		function getTableList($skip_authentication = false){
			$arrTables = array(   
				'mealdates' => 'Date Planner',
				'meals' => 'Meals',
				'recipes' => 'Recipes',
				'ingredients' => 'Ingredients',
				'mealrecipes' => 'Meals & Recipes',
				'recipeingredients' => 'Recipes & Ingredients',
				'ingredientstores' => 'Ingredients & Stores',
				'sources' => 'Sources',
				'stores' => 'Stores'
			);
	...
	function logOutUser(){
		...
		if(isset($_COOKIE['Meal_Planner_rememberMe'])){
			setcookie('Meal_Planner_rememberMe', '', time()-42000);
		}
		session_destroy();
	}
	########################################################################
